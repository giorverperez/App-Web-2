...
exports.ComputadoraModule = ComputadoraModule = __decorate([
    (0, common_1.Module)({
        controllers: [computadora_controller_1.ComputadoraController],
        providers: [computadora_service_1.ComputadoraService],
        imports: [typeorm_1.TypeOrmModule.forFeature([computadora_entity_1.Computadora])],
